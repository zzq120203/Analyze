...
public class LoadConfig {
    ...
    public final void loadConfigFile() {
        ...
        try {
            ...
            String lqc = doc.getElementsByTagName("MaxCrawlThreadCount").item(0).getFirstChild().getNodeValue();
            this.gConfig.maxCrawlThreadCount = Integer.parseInt(lqc);
            String timeout = doc.getElementsByTagName("timeout").item(0).getFirstChild().getNodeValue();
            this.gConfig.timeout = Integer.parseInt(timeout);
	        this.gConfig.getFilePath = doc.getElementsByTagName("GetFilePath").item(0).getFirstChild().getNodeValue();
	        this.gConfig.crawledFilePath = doc.getElementsByTagName("CrawledFilePath").item(0).getFirstChild().getNodeValue();
	        this.gConfig.errorFilePath = doc.getElementsByTagName("ErrorFilePath").item(0).getFirstChild().getNodeValue();
...
//    private void loadBlackWebSites(String filePath) {
...
//                    continue;
//                } else {
//                	this.gConfig.blackWebSiteSet.add(line.trim());
//                }
//            }
//            logger.info("load blackwebsites nr: " + gConfig.blackWebSiteSet.size());
